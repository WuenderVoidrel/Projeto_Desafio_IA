  ...
  const stepsData = [
    {
      ...
      description: "Preencha o formulário de aplicação para participar do nosso programa de acesso antecipado e garantir sua vaga.",
      image: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=800&q=80"
    },
    {
      number: "02",
      title: "Personalização",
      description: "Trabalharemos com você para personalizar o Atlas de acordo com suas necessidades e preferências específicas.",
      image: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=800&q=80"
    },
    {
      number: "03",
      title: "Integração",
      description: "Atlas chega ao seu local e é integrado ao seu ambiente de vida ou trabalho.",
      image: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=800&q=80"
    },
    {
      number: "04",
      title: "Adaptação",
      description: "Através da interação diária, Atlas aprende e se adapta às suas rotinas, preferências e necessidades.",
      image: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=800&q=80"
    }
  ];
    ...
    <section className="py-20 bg-white relative" id="how-it-works" ref={sectionRef}>
      ...
      <div className="section-container">
        <div className="text-center mb-16 opacity-0 fade-in-stagger">
          ...
          <h2 className="section-title mb-4">Como Atlas se Integra à Sua Vida</h2>
          <p className="section-subtitle mx-auto">
            Um processo perfeito de quatro etapas desde a solicitação até a integração completa.
          </p>
        </div>
