      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Inteligência Avançada, <br className="hidden sm:block" />Intuição Humana
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Desenvolvido com tecnologia de ponta para compreender, aprender e se adaptar às suas necessidades únicas.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Atlas aprende com suas interações, melhorando continuamente suas respostas e ações para melhor atender suas necessidades."
            index={0}
          />
          <FeatureCard
            ...
            description="Comunique-se usando linguagem natural e gestos. Atlas compreende o contexto e responde adequadamente."
            index={1}
          />
          <FeatureCard
            ...
            description="Articulações motorizadas avançadas proporcionam movimento fluido e semelhante ao humano com equilíbrio e coordenação excepcionais."
            index={2}
          />
          <FeatureCard
            ...
            description="Sensores avançados e tecnologia de mapeamento permitem que Atlas navegue por ambientes complexos com facilidade."
            index={3}
          />
          <FeatureCard
            ...
            description="Protocolos integrados protegem seus dados e privacidade, enquanto salvaguardas físicas garantem operação segura."
            index={4}
          />
          <FeatureCard
            ...
            title="Assistência em Tarefas"
            description="De lembretes simples a tarefas complexas de múltiplas etapas, Atlas pode auxiliar numa ampla gama de atividades."
            index={5}
          />
        </div>
      </div>
